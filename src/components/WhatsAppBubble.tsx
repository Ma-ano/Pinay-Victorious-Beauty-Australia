  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 flex items-end gap-3">
      <a
        ...
        aria-label="Reach out via WhatsApp"
      >
      ...
      <div
        className={`bg-white dark:bg-card border border-primary/10 rounded-xl px-4 py-2.5 shadow-lg max-w-48 transition-all duration-500 ${
          showTip
      ...
      >
        <p className="text-xs text-foreground leading-relaxed">
          <span className="font-semibold text-dark">Deals & Offers</span>
          <br />
